...
cfg.add_argument(
    "--norm-mode", type=str, choices=("None", "PN", "PN-SI", "PN-SCS"), default="PN"
)
cfg.add_argument("--norm-scale", type=float, default=10.0)
...
class SGC(freerec.models.GenRecArch):
    """
    user/item embds -> PairNorm
    -> symmetric normalized adjacency propagation + PairNorm (K layers)
    -> dropout -> linear transform
    ...
    def __init__(
        ...
        self.linear = nn.Linear(cfg.embedding_dim, cfg.embedding_dim)
