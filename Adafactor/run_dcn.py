...
cfg.add_argument("--decay-rate", type=float, default=-0.8, help="the decay rate for Adafactor (relative step size)")
cfg.add_argument("--eps", type=float, default=1.e-8, help="the eps for Adafactor")
