...
class BERT4Rec(freerec.models.SeqRecArch):
    ...
    -> bidirectional multi-head self-attention encoder (TransformerEncoder)
    -> linear projection to item logits
    -> masked positions only -> CE loss.
    """
    ...
    def __init__(
        ...
        self.layernorm = nn.LayerNorm(cfg.embedding_dim)
        ...
        self.fc = nn.Linear(cfg.embedding_dim, self.Item.count + self.NUM_PADS)
