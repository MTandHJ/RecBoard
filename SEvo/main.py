...
import sys
from optims import get_graph, Smoother, AdamSEvo, AdamWSEvo, SGDSEvo
...
cfg.add_argument("--maxlen4graph", type=int, default=50, help="only the last `maxlen` items in a sequence will be used for construciton")
...
class SASRec(freerec.models.SeqRecArch):
    ...
    def marked_params(self):
        ...
        regular_params = [param for param in self.parameters() if id(param) not in recorded]
        return [
            {'params': regular_params},
            {
                ...
                'smoother': Smoother(
                    ...
                    beta=cfg.beta3, L=cfg.L, aggr=cfg.aggr
                )
            }
        ]
