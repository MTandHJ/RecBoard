...
from quantizer import ResidualSimVQQuantizer
...
class SimVQ(freerec.models.RecSysArch):
    def __init__(self, dataset: freerec.data.datasets.RecDataSet) -> None:
        ...
        self.quantizer = ResidualSimVQQuantizer(
            self.dataset,
            cfg.codebook_dim,
...
class CoachForSimVQ(freerec.launcher.Coach):
