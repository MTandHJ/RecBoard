...
cfg.add_argument(
    "--ssl-weight", type=float, default=0.2, help="the weight for contrastive loss"
)
...
class SimGCL(freerec.models.GenRecArch):
    ...
    + two noise-perturbed propagation views (eps * random noise per layer)
    -> L2-normalize -> cross-view InfoNCE SSL loss.
    """
